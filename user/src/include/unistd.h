...
#define SYS_read 63
#define SYS_write 64
#define SYS_readat 67
#define SYS_writeat 68
#define SYS_seek 62
#define SYS_fstat 80
#define SYS_fsync 82
...
/* Asynccall test */
#define SYS_setup_async_call 500
#endif
...
#define O_CREAT (1 << 6)   // create file if it does not exist
#define O_EXCL (1 << 7)    // error if O_CREAT and the file exists
#define O_TRUNC (1 << 9)   // truncate file upon open
#define O_APPEND (1 << 10) // append on each write
